...
function ProductList() {
    ...
    const cart=useSelector(state=>state.cart.items)//aded
                        ...
                        <div className='product-list'>
                            {
                                category.plants.map((plant,plantIndex)=>(
                                    <div className='product-card' key={plantIndex}>
                                        ...
                                        <button className={`product-button ${addToCart[plant.name]?'added-to-cart':''}`} onClick={()=>handleAddToCart(plant)}>
                                            {addToCart[plant.name]?'Added' :'Add to Cart'}</button>
                                    </div>
                                ))
                            }
                        </div>
